...
exports.IssueWebviewProvider = void 0;
...
class IssueWebviewProvider {
    ...
    async showIssueDetails(issue) {
        const panel = vscode.window.createWebviewPanel('issueDetails', `Issue #${issue.number}: ${issue.title}`, vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true
        });
        panel.webview.html = this._getIssueDetailsHtml(issue);
    }
    _getHtmlForWebview(webview, issues) {
        return `<!DOCTYPE html>
            <html lang="en">
            <head>
                <meta charset="UTF-8">
...
exports.IssueWebviewProvider = IssueWebviewProvider;
IssueWebviewProvider.viewType = 'giteaIssuesWebview';
//# sourceMappingURL=issueWebviewProvider.js.map