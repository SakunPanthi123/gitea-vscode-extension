...
exports.PullRequestWebviewProvider = void 0;
const vscode = require("vscode");
class PullRequestWebviewProvider {
    constructor(_extensionUri, giteaService) {
    ...
    async showPullRequestDetails(pr) {
        const panel = vscode.window.createWebviewPanel('pullRequestDetails', `PR #${pr.number}: ${pr.title}`, vscode.ViewColumn.One, {
            enableScripts: true,
            retainContextWhenHidden: true
        });
        panel.webview.html = this._getPullRequestDetailsHtml(pr);
    }
    _getHtmlForWebview(webview, pullRequests) {
...
exports.PullRequestWebviewProvider = PullRequestWebviewProvider;
PullRequestWebviewProvider.viewType = 'giteaPullRequestsWebview';
//# sourceMappingURL=pullRequestWebviewProvider.js.map